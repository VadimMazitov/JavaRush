...
<c:url var="addAction" value="/add-edit/addAction"/>
...
<div class="container">
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                <p>Type 'True' or 'False' in the relevance field</p>
            </div>
        </div>
...
<tr>
    ...
    <td>
        <form:input path="relevance" pattern="True|true|False|false"/>
    </td>
</tr>
<tr>
    <td>
    ...
    <td>
        <form:input path="number" pattern="(?<![-.])\b[0-9]+\b(?!\.[0-9])"/>
    </td>
</tr>
<tr>
    <td colspan="2">
